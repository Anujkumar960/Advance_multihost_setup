createCertificateForOrderer() {
  ...
  local CA_PORT=$1         # CA port (e.g., 13054)
  local DOMAIN=$2  # Organization domain (e.g., hirestar.com)

  # Variables For Ordereres
  orderers=("orderer7" "orderer8" "orderer9")
...
createCertificateForOrderer 13054 "hirestar.com"