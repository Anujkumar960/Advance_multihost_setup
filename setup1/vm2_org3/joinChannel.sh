...
fetchChannelBlock() {
    ...
    # peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o 157.245.111.15:7050 \
    #     --ordererTLSHostnameOverride orderer.example.com \
    #     -c $CHANNEL_NAME --tls --cafile $ORDERER_CA
    peer channel fetch latest ./channel-artifacts/$CHANNEL_NAME.block -o 157.245.111.15:7050 \
        --ordererTLSHostnameOverride orderer.example.com \
        -c $CHANNEL_NAME --tls --cafile $ORDERER_CA
}
...
updateAnchorPeers() {
    ...
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 157.245.111.15:7050 --ordererTLSHostnameOverride orderer.example.com \
