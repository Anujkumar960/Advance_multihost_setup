...
export PEER0_ORG2_CA=${PWD}/../vm1_org2/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
export PEER0_ORG3_CA=${PWD}/../vm2_org3/crypto-config/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls/ca.crt
...
checkCommitReadyness() {
    ...
    echo "===================== checking commit readyness from org 1 and org 2 ===================== "
}
